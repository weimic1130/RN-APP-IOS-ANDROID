...
export default class RegistrationAndroid extends React.Component {
                            ...
                            <View style={{ flex: 1, width: width, alignItems: "center", justifyContent: "center" }}>
                                ...
                                <View style={styles.loginSty}>
                                    <View>
                                        <TouchableWithoutFeedback onPress={() => this.switchState(0)}>
                                            <View style={this.state.activeIndex == 0 ? styles.Atextactive : styles.noAtextactive}>
                                                <Text style={this.state.activeIndex == 0 ? styles.zcdeText : styles.zcdeText1}>登录</Text>
                                            </View>
                                        </TouchableWithoutFeedback>
                                    </View>
                                    <View>
                                        <TouchableWithoutFeedback onPress={() => this.switchState(1)}>
                                            <View style={this.state.activeIndex == 1 ? styles.Atextactive : styles.noAtextactive}>
                                                <Text style={this.state.activeIndex == 1 ? styles.zcdeText : styles.zcdeText1}>免费注册</Text>
                                            </View>
                                        </TouchableWithoutFeedback>
                                    </View>
                                </View>
                                ...
                                <View style={styles.loginSty1}>
                                    <View style={styles.loginSty1Child}>
                                        ...
                                        <TextInput returnKeyType="done" value={this.state.phone} onChangeText={(text) => this.setState({ phone: text })} placeholderTextColor="#B2B2B2" style={styles.Ainputsty}
                                ...
                                <View style={styles.loginSty1}>
                                    <View style={styles.loginSty1Child}>
                                        ...
                                        <TextInput returnKeyType="done" value={this.state.password} secureTextEntry={true} password={true} onChangeText={(text) => this.setState({ password: text })}
                        ...
                        <KeyboardAvoidingView behavior="position" keyboardVerticalOffset={0}>
                            ...
                            <View style={styles.loginSty}>
                                <View>
                                    <TouchableWithoutFeedback onPress={() => this.switchState(0)}>
                                        <View style={this.state.activeIndex == 0 ? styles.Atextactive : styles.noAtextactive}>
                                            <Text style={this.state.activeIndex == 0 ? styles.zcdeText : styles.zcdeText1}>密码登录</Text>
                                        </View>
                                    </TouchableWithoutFeedback>
                                </View>
                                <View>
                            ...
                            <View style={styles.loginSty1}>
                                <View style={styles.loginSty1Child}>
                                    <Image source={require('./Images/mima.png')} />
                                    <TextInput returnKeyType="done" value={this.state.code} onChangeText={(text) => this.setState({ code: text })} placeholderTextColor="#B2B2B2" style={styles.Ainputsty}
                            ...
                            <View style={styles.loginSty1}>
                                <View style={styles.loginSty1Child}>
                                    <Image source={require('./Images/mima.png')} />
                                    <TextInput returnKeyType="done" secureTextEntry={true} password={true} value={this.state.password} onChangeText={(text) => this.setState({ password: text })}
                                        placeholderTextColor="#B2B2B2"
                                        style={styles.Ainputsty} placeholder="请输入密码"></TextInput>
                                </View>
                            </View>
    ...
    Nextstep() {
        ...
        fetch(
            JFAPI.Register + "?phone=" + data.phone + '&code=' + data.code + '&password=' + data.password, opts)
        ...
        NetInfo.getConnectionInfo().then((connentionInfo) => {
            ...
            if (type == 'none') {
                Alert.alert(
                    ...
                    [
                        { text: '确定', onPress: () => this.openSeting() },
                    ]
                )
            } else {
                let opts = {
