...
let codeTime = 60;
export default class TaichicultureIos extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loadingState:true,
                                                ...
                                                <TouchableWithoutFeedback key={index} onPress={() => this.gotoDetaile(item)}>
                                                    <View style={index + 1 == this.state.DataList.length ? styles.TtquyuNb : styles.Ttquyu}>
                                                        <View style={{width: width * 0.3}}>
                                                            <Image style={{width: 110, height: 75}} source={{uri: 'https://taijiqiu.oss-cn-hangzhou.aliyuncs.com/' + item.imgList[0]}}/>
                                                        </View>
