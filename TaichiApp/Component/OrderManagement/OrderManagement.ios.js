...
let codeTime = 60;
export default class OrderManagementIos extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            switchText: "全部",
                                    ...
                                    this.state.orderList.length > 0 ? this.state.orderList.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                                    ...
                                                                    <View style={styles.TtquyuPar}>
                                                                        <View style={styles.TtquyuPar1}>
                                                                            <Image style={{width: 75, height: 75}}
                                                                                   source={{uri: global.PicUrl + item.goodsImg}}/>
                                                                            <View>
                                                                                <View style={styles.zongriqi}>
                                                                                    <Text numberOfLines={2}
                                                                                          ellipsizeMode="tail">{item.goodsTitle}
                                                                                        <Text
                                                                                            style={{paddingLeft: 10}}>￥{item.goodsMoney / 100}</Text></Text>
                                                                                    {/*<Text style={{paddingRight:8}}>￥{item.goodsMoney / 100}</Text>*/}
                                                                                </View>
                                                                                <View style={styles.zongriqi}>
                                                                                    <Text
                                                                                        style={styles.TtquyuPar11Text2}>{item.spec}</Text>
                                                                                    <Text
                                                                                        style={styles.TtquyuPar11Text2}>x{item.num}</Text>
                                                                                </View>
                                                                                <View style={styles.zongriqi}>
                                                                                    <Text
                                                ...
                                                {
                                                    index + 1 == this.state.orderList.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                        ...
                                        return (
                                            <View key={index}>
                                                <View style={{
                                                    ...
                                                    width: width * 0.96,
                                                    marginLeft: width * 0.02
                                                }}><Text style={{color: "#C22525", fontSize: 14}}>待付款</Text></View>
                                                {
                                                    item.list.map((item, index) => {
                                                        return (
                                                            <View key={index}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList1.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                    ...
                                    this.state.orderList2.length > 0 ? this.state.orderList2.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                    ...
                                                    <View style={styles.TtquyuPar}>
                                                        <View style={styles.TtquyuPar1}>
                                                            ...
                                                            <View>
                                                                <View style={styles.zongriqi}>
                                                                    <Text numberOfLines={2}
                                                                          ellipsizeMode="tail">{item.goodsTitle} <Text
                                                                        style={{paddingLeft: 10}}>￥{item.goodsMoney / 100}</Text></Text>
                                                                    {/*<Text style={{paddingRight:8}}>￥{item.goodsMoney / 100}</Text>*/}
                                                                </View>
                                                                <View style={styles.zongriqi}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList2.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                    ...
                                    this.state.orderList4.length > 0 ? this.state.orderList4.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList4.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                    ...
                                    this.state.orderList5.length > 0 ? this.state.orderList5.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList5.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                    ...
                                    this.state.orderList6.length > 0 ? this.state.orderList6.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList6.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
                                    ...
                                    this.state.orderList3.length > 0 ? this.state.orderList3.map((item, index) => {
                                        return (
                                            <View key={index}>
                                                ...
                                                {
                                                    index + 1 == this.state.orderList3.length ? null :
                                                        <View style={styles.linePad}></View>
                                                }
                                            </View>
                                        )
    ...
    gotoEvaluate = (item) => {
        let self = this;
        this.props.navigation.navigate('EvaluationN', {
            data: item, refresh: function () {
    ...
    gotoRefund = (item) => {
        ...
        this.props.navigation.navigate('RefundN', {
            data: item, type: type, refresf: function () {
