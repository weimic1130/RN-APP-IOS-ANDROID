...
export default class AboutUsIos extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            activeInex: 1,
    ...
    render() {
        return (
            <View style={styles.containerAppAbout}>
                ...
                <View style={styles.AboutChild1}>
                    <View style={styles.AboutChild12}>
                        ...
                        <Text style={{ paddingTop: 12, paddingBottom: 12 }}>{this.state.dataDetails ? this.state.dataDetails.companyProfile : ''}</Text>
                    </View>
                    <View style={styles.AboutChild12}>
                        <Text style={styles.AboutChild12Text}>荣誉资质</Text>
                        {/*<Image source={require('./Images/2.png')} />*/}
                        <HTMLView style={{ paddingTop: 12 }} value={this.state.dataDetails ? this.state.dataDetails.honor : ''} />
