...
export default class RegistrationDetailesIos extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            // 详细地址
    ...
    render() {
        return (
            <View style={styles.containerAppR}>
                <ImageBackground style={{width: '100%', flex: 1}} source={require('./Images/tuceng1.png')}>
                                ...
                                <View style={styles.loginSty1}>
                                    <View style={styles.loginSty1Child}>
                                        ...
                                        <View style={styles.nalifnChid}>
                                            ...
                                            <FontAwesome name={'angle-right'} size={23} color="#B2B2B2"/>
                                        </View>
                                    </View>
                                </View>
                                {/*性别*/}
                    ...
                    {/*}*/}
                    {/*出生日期*/}
                    <ModalBox backdropPressToClose={true} animationDuration={300} style={styles.ModalBoxSty} ref="dateModal">
                    ...
                    {/*选择性别*/}
                    <ModalBox backdropPressToClose={true} style={styles.ModalBoxSty} ref="sexModal">
        ...
        ImagePicker.showImagePicker(options, (response) => {
            ...
            if (response.didCancel) {
                ...
                Alert.alert(
                    ...
                    [
                        {text: '取消'},
                        {text: "确定", onPress: () => this.confirmSettings()}
                    ]
                );
    ...
    completeRegistered() {
        let self = this;
        console.log(self.state.headurl);
