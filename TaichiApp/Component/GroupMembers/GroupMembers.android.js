...
export default class GroupMembersAndroid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            catchData:'',
                            ...
                            this.state.groupList.length > 0 ? this.state.groupList.map((item, index) => {
                                return (
                                    <View key={index} style={styles.containerAppTaiMoreChild1}>
                                        {
                                            item.headUrl ? <View>
                                                <Image style={{width: 45, height: 45, borderRadius: 22}} source={{uri: global.PicUrl + item.headUrl}}/>
                                            </View> : <View>
                                        ...
                                        <View style={styles.containerAppTaiMoreChild12}>
                                            <View>
                                                ...
                                                {
                                                    item.status == 2 ?   <View style={{position: "absolute",justifyContent:"center", alignItems:"center",width:30,height:30, right: 8, top: 10}} >
