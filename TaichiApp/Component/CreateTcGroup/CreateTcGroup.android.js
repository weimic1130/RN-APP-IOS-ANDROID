...
import {
    ...
    ScrollView,
    Animated,
    ActivityIndicator, Picker, Modal, Keyboard
} from "react-native";
...
export default class CreateTcGroupAndroid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            LoadingState: false,
                            ...
                            <TouchableWithoutFeedback onPress={() => this.closeFocus()}>
                                <View style={styles.AboutChild1}>
                                    <View style={styles.AboutChild12}>
                                        ...
                                        <TextInput ref="taijituan" onChangeText={(text) => this.setState({title: text})}
                                    ...
                                    <TouchableWithoutFeedback onPress={() => this.choosePic()}>
                                        <View style={styles.AboutChild12}>
                                            ...
                                            {
                                                this.state.Headportrait ? <Image style={{width: 50, height: 50}}
                                    ...
                                    <View style={styles.AboutChild12S}>
                                        ...
                                        <TextInput ref="qunchengyuan" returnKeyType="done"
                                                   onChangeText={(text) => this.setState({num: text})}
                                                   value={this.state.num} style={styles.changzhudishuruk1}
                                    ...
                                    <View style={styles.AboutChild12N}>
                                        ...
                                        <TextInput ref="jianjie" returnKeyType="done"
                                                   ...
                                                   value={this.state.intro} style={styles.jianjieshuruk}
                        ...
                        <ScrollView keyboardShouldPersistTaps="always" style={{flex: 1, marginBottom: 20}}>
                            <TouchableWithoutFeedback onPress={() => this.closeFocus()}>
                                <View style={styles.AboutChild1}>
                                    ...
                                    <View style={styles.AboutChild12N}>
                                        <Text style={styles.AboutChild12Text}>简介：</Text>
                                        <TextInput ref="jianjie" returnKeyLabel="完成"
                                                   blurOnSubmit={true}
                                                   onChangeText={(text) => this.setState({intro: text})}
                                                   value={this.state.intro} style={styles.jianjieshuruk}
                                                   multiline={true} placeholder="介绍一下您的太极团,方便附近拳友更了解您的太极 团"></TextInput>
    ...
    componentWillMount() {
        ...
        if (this.props.navigation.state.params.data) {
            this.setState({
                ...
                Headportrait: this.props.navigation.state.params.data.img,
            ...
            xhr.onreadystatechange = (e) => {
                ...
                if (xhr.status === 201) {
                    ...
                    this.setState({
                        ...
                        Headportrait: xhr.responseText.match(/<Key>([^<]*)<\/Key>/)[1]
                    })
                    successResponse(xhr);
                } else {
                    xhr.extra = opts.extra;
