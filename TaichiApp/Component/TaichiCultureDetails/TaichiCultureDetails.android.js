...
export default class HeadlinedetailsAndroid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            type: "",
    ...
    render() {
        ...
        return (
            <View style={styles.containerAppHeader}>
                {
                    this.state.CultureDetaile ? <KeyboardAvoidingView style={{ flex: 1 }} behavior={behavior}>
                        <ScrollView style={{ flex: 1, marginBottom: 55 }}>
                            <View style={styles.HeaderTitlecon}>
                                <View style={styles.HeaderTitle}>
                                    <View style={styles.HeaderTitle1}>
                                        <Text style={styles.HeaderTitle1Text1}>{this.state.CultureDetaile.name}</Text>
                                        <Text style={styles.HeaderTitle1Text2}>{this.state.CultureDetaile.browseNum}浏览量 / {this.timestampChangeData(this.state.CultureDetaile.createTime)}</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.conTitle}>
                                <Text style={styles.titleText}>{this.state.CultureDetaile.title}</Text>
                                <Text style={styles.Timetext}>{this.timestampChangeData(this.state.CultureDetaile.createTime)}</Text>
                            </View>
                            ...
                            {/*    <Text style={styles.diansa Num}>{this.state.CultureDetaile.virCollectNum}</Text>*/}
                            {/*</View>*/}
                            {/*评论区域*/}
                            {
                                            ...
                                            return (
                                                <View key={index} style={styles.pyquyuscon}>
                                                    <View style={styles.pyquyuscon1}>
                                                        {
                                                            item.headUrl ? <Image style={{ width: 50, height: 50, borderRadius: 25 }} source={{ uri: global.PicUrl + item.headUrl }} /> :
                                                                <Image style={{ width: 50, height: 50, borderRadius: 25 }} source={require('./Images/bj.png')} />
                                                        }
                                                    </View>
                        ...
                        <View style={styles.box}>
                            <TextInput ref="input" onChangeText={(text) => this.setState({ comment: text })} value={this.state.comment} style={styles.input} placeholderTextColor='#999999'
                                placeholder={'评论内容'} underlineColorAndroid="transparent" />
