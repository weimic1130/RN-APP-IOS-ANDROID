...
export default class TaiJiCardAndroid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loadingState:false,
                        ...
                        <View style={styles.boxCardChild2}>
                            <View style={styles.boxCardChild213}>
                                <View style={styles.boxCardChild2131}>
                                    ...
                                    <Text style={styles.boxCardChild2131Text1}>{this.state.address == 'undefined' ? '' : this.state.address}</Text>
                                </View>
                            </View>
    ...
    getDetails = (groupsId, userId) => {
        ...
        fetch(url, opts)
            .then((response) => response.json())
            .then((res) => {
                console.log('团详情', res.data.address);
                if (res.code == 0) {
