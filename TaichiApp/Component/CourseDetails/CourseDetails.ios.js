    ...
    render() {
        return (
            <View style={styles.containerAppCDeta}>
                {
                    this.state.detalsData ? <ScrollView style={{flex: 1, width: "100%"}}>
                        {
                            this.state.detalsData.imgList ? <Image style={{width: width, height: 200}}
                                                                   source={{uri: global.PicUrl + this.state.detalsData.imgList[0]}}/> :
                                <Image style={{width: width}} source={require('./Images/bj.png')}/>
                        }
                        {/*点赞分享区域*/}
                        ...
                        <View style={styles.allconCour}>
                            <View style={styles.allconCourChidl}>
                                <TouchableWithoutFeedback onPress={() => this.switchNav(1)}>
                                    <View
                                        style={this.state.activeInex == 1 ? styles.allconCourChidlTextActive2 : styles.allconCourChidlText}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => this.VideoFullscreen()}>
                                        <View style={styles.screenSty}>
                                            <Image style={{width: 25, height: 25}}
                                                   source={require('./Images/quanpin.png')}/>
                                        </View>
                                    </TouchableWithoutFeedback>
                                    {/*播放*/}
                                    {
                ...
                {/*底部输入框*/}
                {
                    this.state.activeInex == 3 ? <View style={styles.box}>
                        <TextInput ref="input" style={styles.input} placeholderTextColor='#999999'
