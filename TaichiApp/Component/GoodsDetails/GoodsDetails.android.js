...
let self = this;
export default class GoodsDetailsAndroid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            deilImg: '',
                    ...
                    <View style={styles.selectTypeGood}>
                        <View style={styles.selectTypeGood1}>
                            <View style={{ flexDirection: "row" }}>
                                {
                                    this.state.deilImg ? <Image style={styles.goodImgSize} source={{ uri: global.PicUrl + this.state.deilImg }} /> : <Image style={styles.goodImgSize} source={require('./Images/bj.png')} />
                                }
    ...
    componentDidMount() {
        ...
        setTimeout(() => {
            ...
            this.getEvaluationList(goodsId, 0, 1, 5);
        }, 10)
    }
